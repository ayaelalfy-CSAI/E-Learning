    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseExams", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentStudentCourse", x => new { x.AssignmentsId, x.StudentCourseId });
                    table.ForeignKey(
                        name: "FK_AssignmentStudentCourse_Assignments_AssignmentsId",
                        column: x => x.AssignmentsId,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentStudentCourse_StudentCourses_StudentCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamStudentCourse", x => new { x.ExamsId, x.StudentCoursesId });
                    table.ForeignKey(
                        name: "FK_ExamStudentCourse_Exams_ExamsId",
                        column: x => x.ExamsId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamStudentCourse_StudentCourses_StudentCoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentStudentCourse_StudentCourseId",
                table: "AssignmentStudentCourse",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamStudentCourse_StudentCoursesId",
                table: "ExamStudentCourse",
